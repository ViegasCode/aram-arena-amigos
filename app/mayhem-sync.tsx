...
export default function MayhemSync({players,knownIds,onUpdated,signedIn}:{players:any[];knownIds:string[];onUpdated:()=>Promise<unknown>;signedIn:boolean}){

...
function iconUrl(path){const clean=String(path||'').replace(/^\/lol-game-data\/assets\//i,'assets/').toLowerCase();return clean?`https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/${clean}`:'';}
